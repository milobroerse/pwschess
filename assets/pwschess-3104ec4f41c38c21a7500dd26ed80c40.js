...
return i}),validMove:Ember.computed("move","boardArray","fenInfo",function(){var e=Ember.get(this,"move"),t=JSON.parse(JSON.stringify(Ember.get(this,"fenInfo"))),i=Ember.get(this,"boardArray").toArray(),r=this.mvToMoveObject(t,e,i)
return this.checkValid(r)}),tiles:Ember.computed("board","boardArray",function(){var e,t=Ember.get(this,"board").toArray(),i=Ember.get(this,"boardArray").toArray()
...
var i=this.makeMove(e)
if("w"===i.ToMove){for(var r=0;r<i.b.length;r++)"k"===i.b[r]&&(i.toIndex=r)
for(var n=0;n<i.b.length;n++)if(this.isWhite(i.b[n])){i.fromIndex=n
var a=this.checkMove(i)
a.valid&&(t=!1),i.CastlingCheck&&(2===i.toIndex?a.toIndex=3:a.toIndex=5,a.valid=!0,(a=this.checkMove(a)).valid&&(t=!1),a.toIndex=4,a.valid=!0,(a=this.checkMove(a)).valid&&(t=!1))}}else{for(var s=0;s<i.b.length;s++)"K"===i.b[s]&&(i.toIndex=s)
for(var o=0;o<i.b.length;o++)if(this.isBlack(i.b[o])){i.fromIndex=o
var l=this.checkMove(i)
l.valid&&(t=!1),i.CastlingCheck&&(58===i.toIndex?l.toIndex=59:l.toIndex=61,l.valid=!0,(l=this.checkMove(l)).valid&&(t=!1),l.toIndex=60,l.valid=!0,(l=this.checkMove(l)).valid&&(t=!1))}}}else t=!1
...
var f=l[a]
l[a]=1,l[s]=f,"K"===f&&(n[1]=n[1].replace(/K/,""),n[1]=n[1].replace(/Q/,""),62===s&&60===a&&(l[63]=1,l[61]="R",t.CastlingCheck=!0),58===s&&60===a&&(l[56]=1,l[59]="R",t.CastlingCheck=!0)),"k"===f&&(n[1]=n[1].replace(/k/,""),n[1]=n[1].replace(/q/,""),2===s&&4===a&&(l[0]=1,l[3]="r",t.CastlingCheck=!0),6===s&&4===a&&(l[7]=1,l[5]="r",t.CastlingCheck=!0)),"R"===f&&(56===a&&(n[1]=n[1].replace(/Q/,"")),63===a&&(n[1]=n[1].replace(/K/,""))),"r"===f&&(0===a&&(n[1]=n[1].replace(/q/,"")),7===a&&(n[1]=n[1].replace(/k/,""))),n[2]="-","P"===f&&(s<8&&(l[s]=o.toUpperCase()),a-s==16&&(n[2]=this.indexToAlgebraic(a-8)),this.algebraicToIndex(t.EnPassant)===s&&(l[s+8]=1)),"p"===f&&(s>55&&(l[s]=o.toLowerCase()),s-a==16&&(n[2]=this.indexToAlgebraic(a+8)),this.algebraicToIndex(t.EnPassant)===s&&(l[s-8]=1)),n[1]||(n[1]="-")
for(var p="",u=0,d=0;d<8;d++){for(var h=0,m=0;m<8;m++){var v=l[u]
u++,isNaN(v)?(h&&(p+=h),p+=v,h=0):h++}h&&(p+=h),d<7&&(p+="/")}p=p+" "+n.join(" ")}return t.b=l,t.Fen=p,t},lineCheck:function(e,t,i,r){var n=!0,a=e%8,s=Math.floor(e/8),o=t%8,l=Math.floor(t/8),c=Math.abs(a-o),f=Math.abs(s-l),p=(t-e)/Math.max(c,f)
if(("Q"===r||"q"===r)&&0!==c&&0!==f&&c!==f)return!1
if(("R"===r||"r"===r)&&0!==c&&0!==f)return!1
if(("B"===r||"b"===r)&&c!==f)return!1
if(("K"===r||"k"===r)&&(c>1||f>1))return!1
if(("K0-0"===r||"k0-0"===r)&&2!==c&&0!==f)return!1
...
var a=t.split(""),s=[]
s[0]=a[0]+a[1],s[1]=a[2]+a[3],s[2]=a[4],r.fromIndex=this.algebraicToIndex(s[0]),r.toIndex=this.algebraicToIndex(s[1]),s[2]&&(r.piecePromotion=s[2].toLowerCase()),r.b=i}return r.valid=n,r},actions:{playMove:function(){var e=Ember.get(this,"move"),t=JSON.parse(JSON.stringify(Ember.get(this,"fenInfo"))),i=Ember.get(this,"boardArray").toArray(),r=this.mvToMoveObject(t,e,i)
if(this.checkValid(r)){for(var n,a=this.makeMove(r),s=!1;!s;)for(var o=0;o<a.b.length;o++)this.isBlack(a.b[o])&&!s&&(a.fromIndex=o,s||(a.toIndex=Math.floor(63*Math.random()),a.fromIndex!==a.toIndex&&(a.valid=!0,s=this.checkValid(a))))
console.log("ok"),n=this.makeMove(a),Ember.set(this,"fen",n.Fen),Ember.set(this,"move","")}}}})}),define("pwschess/helpers/app-version",["exports","pwschess/config/environment","ember-cli-app-version/utils/regexp"],function(e,t,i){function r(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=t.default.APP.version,a=r.versionOnly||r.hideSha,s=r.shaOnly||r.hideVersion,o=null
...
return Object.defineProperty(i,"__esModule",{value:!0}),i}catch(t){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("pwschess/app").default.create({name:"pwschess",version:"0.0.0+7083784a"})

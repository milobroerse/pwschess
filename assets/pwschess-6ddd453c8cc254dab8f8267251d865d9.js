...
var l=this.checkMove(a)
l.valid&&(e=!1),a.CastlingCheck&&(2===a.toIndex?l.toIndex=3:l.toIndex=5,l.valid=!0,(l=this.checkMove(l)).valid&&(e=!1),l.toIndex=4,l.valid=!0,(l=this.checkMove(l)).valid&&(e=!1))}}else{for(var c=0;c<a.b.length;c++)"K"===a.b[c]&&(a.toIndex=c)
for(var f=0;f<a.b.length;f++)if(this.isBlack(a.b[f])){a.fromIndex=f
var p=this.checkMove(a)
p.valid&&(e=!1),a.CastlingCheck&&(58===a.toIndex?p.toIndex=59:p.toIndex=61,p.valid=!0,(p=this.checkMove(p)).valid&&(e=!1),p.toIndex=60,p.valid=!0,(p=this.checkMove(p)).valid&&(e=!1))}}}else e=!1
...
return r=r.replace(/-/g,""),{FenTrue:!0,Fen:t,ToMove:i[0],CastlingWk:i[1].includes("K"),CastlingWq:i[1].includes("Q"),CastlingBk:i[1].includes("k"),CastlingBq:i[1].includes("q"),EnPassant:r}}}return{FenTrue:!1}}),checkMove:function(e){var t=!1,i=JSON.parse(JSON.stringify(e))
...
return Object.defineProperty(i,"__esModule",{value:!0}),i}catch(t){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("pwschess/app").default.create({name:"pwschess",version:"0.0.0+92036b78"})

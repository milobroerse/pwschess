...
if("w"===i.ToMove){for(var n=0;n<i.b.length;n++)"k"===i.b[n]&&(i.toIndex=n,r=!0)
if(r)for(var a=0;a<i.b.length;a++)if(this.isWhite(i.b[a])){i.fromIndex=a
var s=this.checkMove(i)
s.valid&&(t=!1),i.CastlingCheck&&(2===i.toIndex?s.toIndex=3:s.toIndex=5,s.valid=!0,(s=this.checkMove(s)).valid&&(t=!1),s.toIndex=4,s.valid=!0,(s=this.checkMove(s)).valid&&(t=!1))}}else{for(var o=0;o<i.b.length;o++)"K"===i.b[o]&&(i.toIndex=o,r=!0)
if(r)for(var l=0;l<i.b.length;l++)if(this.isBlack(i.b[l])){i.fromIndex=l
...
p++,isNaN(v)?(h&&(d+=h),d+=v,h=0):h++}h&&(d+=h),u<7&&(d+="/")}d=d+" "+n.join(" ")}return t.b=l,t.Fen=d,t},lineCheck:function(e,t,i,r){var n=!0,a=e%8,s=Math.floor(e/8),o=t%8,l=Math.floor(t/8),f=Math.abs(a-o),c=Math.abs(s-l),d=(t-e)/Math.max(f,c)
...
for(var p=e+d;p!==t;p+=d)this.isEmpty(i[p])||(n=!1)
...
var a=t.split(""),s=[]
s[0]=a[0]+a[1],s[1]=a[2]+a[3],s[2]=a[4],r.fromIndex=this.algebraicToIndex(s[0]),r.toIndex=this.algebraicToIndex(s[1]),s[2]&&(r.piecePromotion=s[2].toLowerCase()),r.b=i}return r.valid=n,r},actions:{playMove:function(){var e=this,t=Ember.get(this,"move"),i=JSON.parse(JSON.stringify(Ember.get(this,"fenInfo"))),r=Ember.get(this,"boardArray").toArray(),n=this.mvToMoveObject(i,t,r)
if(this.checkValid(n)){var a=this.makeMove(n)
Ember.set(this,"fen",a.Fen),Ember.run.later(function(){for(var t,i=Ember.get(e,"move"),r=JSON.parse(JSON.stringify(Ember.get(e,"fenInfo"))),n=Ember.get(e,"boardArray").toArray(),a=e.mvToMoveObject(r,i,n),s=[],o=0;o<a.b.length;o++)if(e.isBlack(a.b[o])){a.fromIndex=o
for(var l=0;l<a.b.length;l++)a.toIndex=l,a.fromIndex!==a.toIndex&&(a.valid=!0,e.checkValid(a)&&s.push(e.indexToAlgebraic(a.fromIndex)+e.indexToAlgebraic(a.toIndex)))}if(console.log(s),console.log("ok"),0!==s.length){var f=s[Math.floor(Math.random()*(s.length-1))].split(""),c=[]
c[0]=f[0]+f[1],c[1]=f[2]+f[3],c[2]=f[4],a.fromIndex=e.algebraicToIndex(c[0]),a.toIndex=e.algebraicToIndex(c[1]),t=e.makeMove(a),Ember.set(e,"fen",t.Fen),Ember.set(e,"move","")}else{for(var d,p=!1,u=0;u<a.b.length;u++)"k"===a.b[u]&&(d=u)
for(var h=0;h<a.b.length;h++)e.isWhite(a.b[h])&&!p&&(a.fromIndex=h,a.toIndex=d,a.ToMove="w",e.checkValid(a)&&(p=!0))
p?console.log("mat"):console.log("pat")}},1500)}}}})}),define("pwschess/helpers/app-version",["exports","pwschess/config/environment","ember-cli-app-version/utils/regexp"],function(e,t,i){function r(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=t.default.APP.version,a=r.versionOnly||r.hideSha,s=r.shaOnly||r.hideVersion,o=null
...
return Object.defineProperty(i,"__esModule",{value:!0}),i}catch(t){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("pwschess/app").default.create({name:"pwschess",version:"0.0.0+bef61730"})
